...
class softmax_classifier(object):
    ...
    def prediction(self):
        """
        Berechnung der logids durch Aufruf der ausgelagerten Funktionen (bzw. Struktur)
        """
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    def train_neo(self, n_epochs):
        """
        Trainieren des Modells mit anschließender Überprüfung der Genauigkeit
        """
